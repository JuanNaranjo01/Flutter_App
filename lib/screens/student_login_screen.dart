...
class _StudentLoginScreenState extends State<StudentLoginScreen> {
  ...
  Future<void> _handleStudentGoogleLogin() async {
    setState(() => _isLoading = true);

    try {
      final dataProvider = Provider.of<DataProvider>(context, listen: false);
      final result = await dataProvider.authService.signInAsStudent();
      ...
      if (result.success && result.student != null) {
        dataProvider.loginWithStudent(result.student!);
        Navigator.of(context).pushReplacementNamed('/student_face_registration');
  ...
  Future<void> _retryVerification() async {
    ...
    try {
      ...
      if (result.success && result.student != null) {
        ...
        _showError('La VPN no está conectada. Por favor verifica tu conexión VPN.');
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: _isLoading ? null : _handleStudentGoogleLogin,
                            style: ElevatedButton.styleFrom(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Solo estudiantes registrados pueden continuar',
                                    style: TextStyle(
                                      fontSize: 13,
